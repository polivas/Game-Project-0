...
namespace Game_Project_0.Collisions
{
    public class CollisionHelper
    {
        ...
        /// <summary>
        /// Detects the collision between rectangles
        /// </summary>
        ...
        /// <summary>
        /// Detects a collsion between a rectangle and a circle
        /// </summary>
        /// <param name="c">a BoundingCircle</param>
        /// <param name="r">a boundingRectangle</param>
